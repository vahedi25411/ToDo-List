...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryString = "CREATE TABLE " + Contract.TABLE_TODO.TABLE_NAME + " ("+
                ...
                Contract.TABLE_TODO.COLUMN_NAME_CATEGORY + " INTEGER DEFAULT 0," + // this line is going to create category column in todoitem table
                Contract.TABLE_TODO.COLUMN_NAME_IS_DONE + " INTEGER DEFAULT 0); "; // this line is going to create status column in todoitem table
